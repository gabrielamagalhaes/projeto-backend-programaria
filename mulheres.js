...
const cors = require('cors')    //aqui estou trazendo o pacote cors que permite consumir esta api no frontend
...
app.use(router.delete('/mulheres/:id', deletaMulher))       //configuerei rota DELETE /mulheres/:id
